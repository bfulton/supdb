...
//! sets a size budget that a whole browser client fits inside. A binding
...
//! W1.2), so the limit is two orders of magnitude clear of anything a
//! browser will hand it, and keeping it out of BigInt keeps the JS glue
//! plain. An
